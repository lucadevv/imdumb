...
void main() {
  ...
  group('Home Screen', () {
    ...
    testWidgets('debería mostrar todas las secciones principales', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('debería mostrar botones "Ver más" en las secciones', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(const App());
      await tester.pumpAndSettle();
    ...
    testWidgets('debería mostrar el botón de búsqueda en el AppBar', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(const App());
      await tester.pumpAndSettle();
    ...
    testWidgets('debería mostrar el botón de menú en el AppBar', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(const App());
      await tester.pumpAndSettle();
